        ...
        <div class="widget widget-table" style="overflow:auto;">
         ...
         <div class="widget-content">
             <table id="featured-datatable" class="table table-sorting table-striped table-hover datatable">
                                ...
                                <thead>
                                    <tr>
                                        <th>arabic name</th><th>english name</th><th>update</th>
                                       <th>delete</th>
                               ...
                               <tbody>
                                        ...
                                        for ($i=0; $i < count($data); $i++) { 
                                            ...
                                            <td> <a href="'.base_url().'admin/food_type/edit?id='.$data[$i]["id"].'&lang=en" > <img src="'.base_url().'rec/img/edit.png" alt=""> </a> 
                                            </td>

                                            <td> 
                                            <button class="btn btn-danger" data-href="
                                            '.base_url().'admin/food_type/delete?id='.$data[$i]["id"].'&lang=en " data-toggle="modal" data-target="#confirm-delete">
