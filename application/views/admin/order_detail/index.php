        ...
        <div class="widget widget-table" style="overflow:auto;">
         ...
         <div class="widget-content">
             <table id="featured-datatable" class="table table-sorting table-striped table-hover datatable">
                                ...
                                <thead>
                                    <tr>
                                        <th>order_id</th><th>product_id</th><th>quantity</th><th>price</th><th>Edit</th>
                                       <th>Delete</th>
                               ...
                               <tbody>
                                        ...
                                        for ($i=0; $i < count($data); $i++) { 
                                            ...
                                            <td> <a href="'.base_url().'admin/order_detail/edit?id='.$data[$i]["id"].'" > <img src="'.base_url().'rec/img/edit.png" alt=""> </a> 
                                            </td>

                                            <td> 
                                            <button class="btn btn-danger" data-href="
                                            '.base_url().'admin/order_detail/delete?id='.$data[$i]["id"].' " data-toggle="modal" data-target="#confirm-delete">
