                        ...
                        <?php 
                                ...
                                ?>
                                        ...
                                        <div class='form-group'>
                                            <label for='validate-select' class='col-md-3 control-label'>Select restaurant</label>
                                    ...
                                    <?php 
                                if(form_error('payment_type_id'))
                                {

                                    echo' <ul>'; 
                                       
                                    echo'  <li class="col-md-12" style="color:red !important">  '.form_error('payment_type_id').'</li>
                                    <br><br></ul>';
                                ...
                                ?>
                                        ...
                                        <div class='form-group'>
                                            <label for='validate-select' class='col-md-3 control-label'>Select payment</label>

                                            <div class='col-md-8 input-group'>
                                                <select class='form-control'  id='validate-select' name='payment_type_id' required>
                                               ...
                                               if(!empty($data))
                                               {
                                                for($i=0, $c = 0;$i<count($payment_type);$i++)
                                                {

                                                    
                                                    if ($data["payment_type_id"] == $payment_type[$i]["id"] ) 
                                                    {
                                                        
                                                       echo ' 
                                                       <option value ="'.$payment_type[$i]["id"].'">'.$payment_type[$i]["name_ar"] .' </option>  ';
                                                       break;
                                                   }
                                                   else
                                                   {
