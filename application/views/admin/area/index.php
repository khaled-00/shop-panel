        ...
        <div class="widget widget-table" style="overflow:auto;">
         ...
         <div class="widget-content">
             <table id="featured-datatable" class="table table-sorting table-striped table-hover datatable">
                                ...
                                <thead>
                                    <tr>
                                        <th>الاسم بالاعربية</th><th>الاسم بالانجليزية</th><th>المنطقة</th><th>تعديل</th>
                                       <th>حذف</th>
                               ...
                               <tbody>
                                        ...
                                        for ($i=0; $i < count($data); $i++) { 
                                            ...
                                            <td> <a href="'.base_url().'admin/area/edit?id='.$data[$i]["id"].'" > <img src="'.base_url().'rec/img/edit.png" alt=""> </a> 
                                            </td>

                                            <td> 
                                            <button class="btn btn-danger" data-href="
                                            '.base_url().'admin/area/delete?id='.$data[$i]["id"].' " data-toggle="modal" data-target="#confirm-delete">
