             ...
             <table id="featured-datatable" class="table table-sorting table-striped table-hover datatable">
                               ...
                               <tbody>
                                        ...
                                        for ($i=0; $i < count($data); $i++) { 
                                            ...
                                            '.base_url().'admin/orders/delete?id='.$data[$i]["id"].' " data-toggle="modal" data-target="#confirm-delete">
                                            <span class="glyphicon glyphicon-trash" aria-hidden="true"></span> حذف الطلب
                                            </button>
                                            </td>
                                            </tr> '; 
