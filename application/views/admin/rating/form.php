                        ...
                        <?php 
                                ...
                                ?>
                                    ...
                                    <div class='form-group'>
                                        <label class='col-md-3 control-label'>restaurant_id</label>
                                        <div class='col-md-8'>
                                            <input type='text' class='form-control' name='restaurant_id' value='<?php if(isset($data["restaurant_id"]) ) echo $data["restaurant_id"] ?>'/>
