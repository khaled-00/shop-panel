        ...
        <div class="widget widget-table" style="overflow:auto;">
         ...
         <div class="widget-content">
             <table id="featured-datatable" class="table table-sorting table-striped table-hover datatable">
                                ...
                                <thead>
                                    <tr>
                                        <th>area_id</th><th>street</th><th>floor</th><th>client_id</th><th>Edit</th>
                                       <th>Delete</th>
                               ...
                               <tbody>
                                        ...
                                        for ($i=0; $i < count($data); $i++) { 
                                            ...
                                            <td> <a href="'.base_url().'admin/addresses/edit?id='.$data[$i]["id"].'" > <img src="'.base_url().'rec/img/edit.png" alt=""> </a> 
                                            </td>

                                            <td> 
                                            <button class="btn btn-danger" data-href="
                                            '.base_url().'admin/addresses/delete?id='.$data[$i]["id"].' " data-toggle="modal" data-target="#confirm-delete">
