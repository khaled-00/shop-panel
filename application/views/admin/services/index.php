             ...
             <table id="featured-datatable" class="table table-sorting table-striped table-hover datatable">
                               ...
                               <tbody>
                                        ...
                                        for ($i=0; $i < count($data); $i++) { 
                                            ...
                                            <td> <a href="'.base_url().'admin/services/edit?id='.$data[$i]["id"].'" > <img src="'.base_url().'rec/img/edit.png" alt=""> </a> 
                                            </td>

                                            <td> 
                                            <button class="btn btn-danger" data-href="
                                            '.base_url().'admin/services/delete?id='.$data[$i]["id"].' " data-toggle="modal" data-target="#confirm-delete">
