        ...
        <div class="widget widget-table" style="overflow:auto;">
         ...
         <div class="widget-content">
             <table id="featured-datatable" class="table table-sorting table-striped table-hover datatable">
                                ...
                                <thead>
                                    <tr>
                                        <th>email</th><th>mobile</th><th>address</th><th>facebook</th><th>twitter</th><th>instgram</th><th>snapchat</th><th>youtube</th><th>Edit</th>
                                       <th>Delete</th>
                               ...
                               <tbody>
                                        ...
                                        for ($i=0; $i < count($data); $i++) { 
                                            ...
                                            <td>'.$data[$i]["instgram"].'</td>
                                            <td>'.$data[$i]["snapchat"].'</td>
                                            <td>'.$data[$i]["youtube"].'</td>
                                            
                                            <td> <a href="'.base_url().'admin/about/edit?id='.$data[$i]["id"].'" > <img src="'.base_url().'rec/img/edit.png" alt=""> </a> 
                                            </td>

                                            <td> 
                                            <button class="btn btn-danger" data-href="
                                            '.base_url().'admin/about/delete?id='.$data[$i]["id"].' " data-toggle="modal" data-target="#confirm-delete">
