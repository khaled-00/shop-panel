                        ...
                        <?php 
                                            ...
                                            <div class='col-md-8 input-group'>
                                               ...
                                               if(!empty($data))
                                               {
                                                for($i=0, $c = 0;$i<count($providers);$i++)
                                                {
                                                    ...
                                                    if ($data["client_id"] == $providers[$i]["id"] ) 
                                                    {
                                                        
                                                       echo ' 
                                                       <option value ="'.$providers[$i]["id"].'">'.$providers[$i]["name"] .' </option>  ';
                                                       break;
                                                   }
                                                   else
                                                   {
                                ...
                                ?>
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-md-8'>
                                            <textarea class='form-control' name='comment'><?php if(isset($data["comment"]) ) echo $data["comment"] ?></textarea>
                                        </div>
                                    </div>
