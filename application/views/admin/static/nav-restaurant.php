            ...
            <div class="sidebar-scroll" >
                <nav class="main-nav" >
                    <ul class="main-menu" >
                        ...
                        <li class="active"><a href="#" class="js-sub-menu-toggle"><i class="fa fa-dashboard fa-fw"></i><span class="text">بيانات المطعم</span>
                            <i class="toggle-icon fa fa-angle-down"></i></a>
                            <ul class="sub-menu">

                                <li><a href="<?php echo base_url(); ?>admin/restaurant/my"><span class="text">بيانات المطعم</span></a></li>
                            
                                 </ul>
                        </li>

                        <li class="active"><a href="#" class="js-sub-menu-toggle"><i class="fa fa-dashboard fa-fw"></i><span class="text">فروع المطعم</span>
                            <i class="toggle-icon fa fa-angle-down"></i></a>
                            <ul class="sub-menu">

                                <li><a href="<?php echo base_url(); ?>admin/restaurant_area"><span class="text">فروع المطاعم</span></a></li>
                             <li><a href="<?php echo base_url(); ?>admin/restaurant_area/add"><span class="text">اضافة فرع</span></a></li>
                            
                                 </ul>
                        </li>

                        <li class="active"><a href="#" class="js-sub-menu-toggle"><i class="fa fa-dashboard fa-fw"></i><span class="text">قوائم الطعام</span>
                            <i class="toggle-icon fa fa-angle-down"></i></a>
                            <ul class="sub-menu">

                                <li><a href="<?php echo base_url(); ?>admin/restaurant/menus"><span class="text">قوائم الطعام</span></a></li>
                                <li><a href="<?php echo base_url(); ?>admin/menus/add"><span class="text">
                                اضافة قائمة</span></a></li>
                                
                                 </ul>
                        </li>

                        <li class="active"><a href="#" class="js-sub-menu-toggle"><i class="fa fa-dashboard fa-fw"></i><span class="text">الوجبات</span>
                            <i class="toggle-icon fa fa-angle-down"></i></a>
                            <ul class="sub-menu">

                                <li><a href="<?php echo base_url(); ?>admin/restaurant/meals"><span class="text">الوجبات</span></a></li>
                                <li><a href="<?php echo base_url(); ?>admin/meals/add"><span class="text">
                                اضافة وجبة</span></a></li>
                                
                                 </ul>
                        </li>

                        <li class=""><a href="#" class="js-sub-menu-toggle"><i class="fa fa-dashboard fa-fw"></i><span class="text">الطلبيات</span>
                            <i class="toggle-icon fa fa-angle-left"></i></a>
                            <ul class="sub-menu">

                                <li><a href="<?php echo base_url() ?>admin/restaurant/orders"><span class="text">الطلبيات</span></a></li>
                                <li><a href="<?php echo base_url() ?>admin/restaurant/orders_complete"><span class="text">الطلبات المكتملة</span></a></li>
                                <li><a href="<?php echo base_url() ?>admin/restaurant/orders_cancel"><span class="text">الطلبات الملغية</span></a></li>
                                <li><a href="<?php echo base_url() ?>admin/restaurant/orders_open"><span class="text">الطلبات المنتظرة</span></a></li>
                                <li><a href="<?php echo base_url() ?>admin/restaurant/orders_delivery"><span class="text">طلبات تم شحنها</span></a></li>
                                 </ul>
                        </li>
