            ...
            <div class="sidebar-scroll" >
                <nav class="main-nav" >
                    <ul class="main-menu" >
                        ...
                        <li class="active"><a href="#" class="js-sub-menu-toggle"><i class="fa fa-dashboard fa-fw"></i><span class="text">my information</span>
                            <i class="toggle-icon fa fa-angle-down"></i></a>
                            <ul class="sub-menu">

                                <li><a href="<?php echo base_url(); ?>admin/restaurant/my?lang=en"><span class="text">my information</span></a></li>
                            
                                 </ul>
                        </li>

                        <li class="active"><a href="#" class="js-sub-menu-toggle"><i class="fa fa-dashboard fa-fw"></i><span class="text">restaurant branches</span>
                            <i class="toggle-icon fa fa-angle-down"></i></a>
                            <ul class="sub-menu">

                                <li><a href="<?php echo base_url(); ?>admin/restaurant_area?lang=en"><span class="text">restaurant branches</span></a></li>
                             <li><a href="<?php echo base_url(); ?>admin/restaurant_area/add?lang=en"><span class="text">add branch</span></a></li>
                            
                                 </ul>
                        </li>

                        <li class="active"><a href="#" class="js-sub-menu-toggle"><i class="fa fa-dashboard fa-fw"></i><span class="text">menus</span>
                            <i class="toggle-icon fa fa-angle-down"></i></a>
                            <ul class="sub-menu">

                                <li><a href="<?php echo base_url(); ?>admin/restaurant/menus?lang=en"><span class="text">menus</span></a></li>
                                <li><a href="<?php echo base_url(); ?>admin/menus/add?lang=en"><span class="text">
                                add menu</span></a></li>
                                
                                 </ul>
                        </li>

                        <li class="active"><a href="#" class="js-sub-menu-toggle"><i class="fa fa-dashboard fa-fw"></i><span class="text">meals</span>
                            <i class="toggle-icon fa fa-angle-down"></i></a>
                            <ul class="sub-menu">

                                <li><a href="<?php echo base_url(); ?>admin/restaurant/meals?lang=en"><span class="text">meals</span></a></li>
                                <li><a href="<?php echo base_url(); ?>admin/meals/add?lang=en"><span class="text">
                                add meal</span></a></li>
                                
                                 </ul>
                        </li>

                        <li class=""><a href="#" class="js-sub-menu-toggle"><i class="fa fa-dashboard fa-fw"></i><span class="text">Orders</span>
                            <i class="toggle-icon fa fa-angle-left"></i></a>
                            <ul class="sub-menu">

                                <li><a href="<?php echo base_url() ?>admin/restaurant/orders?lang=en"><span class="text">Orders</span></a></li>
                                <li><a href="<?php echo base_url() ?>admin/restaurant/orders_complete?lang=en"><span class="text">orders completed</span></a></li>
                                <li><a href="<?php echo base_url() ?>admin/restaurant/orders_cancel?lang=en"><span class="text">orders canceled</span></a></li>
                                <li><a href="<?php echo base_url() ?>admin/restaurant/orders_open?lang=en"><span class="text">orders waiting</span></a></li>
                                <li><a href="<?php echo base_url() ?>admin/restaurant/orders_delivery?lang=en"><span class="text">orders delivered</span></a></li>
                                 </ul>
                        </li>
