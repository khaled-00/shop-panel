                ...
                <nav class="main-nav" >
                    <ul class="main-menu" >
                        ...
                        <?php for ($i = 0; $i < count($side); $i++) {
                            ...
                            {
                                echo '<li class=""><a href="#" class="js-sub-menu-toggle"><i class="fa fa-dashboard fa-fw"></i><span class="text">'.$side[$i]['index_view'].'</span>
                            <i class="toggle-icon fa fa-angle-left"></i></a>
                            <ul class="sub-menu">

                                <li><a href="'.base_url().'admin/'.$side[$i]['index_controller'].'"><span class="text">'.$side[$i]['index_view'] .'</span></a></li>
                                <li><a href="'.base_url().'admin/orders/complete"><span class="text">الطلبات المكتملة</span></a></li>
                                <li><a href="'.base_url().'admin/orders/cancel"><span class="text">الطلبات الملغية</span></a></li>
                                <li><a href="'.base_url().'admin/orders/open"><span class="text">الطلبات المنتظرة</span></a></li>
                                <li><a href="'.base_url().'admin/orders/delivery"><span class="text">طلبات تم شحنها</span></a></li>
                                 </ul>
                        </li>';
                            }
                            else {
                        ...
                        <li class="active"><a href="#" class="js-sub-menu-toggle"><i class="fa fa-dashboard fa-fw"></i><span class="text"><?php echo $side[$i]['index_view'] ?></span>
                            <i class="toggle-icon fa fa-angle-down"></i></a>
                            <ul class="sub-menu">

                                <li><a href="<?php echo base_url(); ?>admin/<?php echo $side[$i]['index_controller'] ?>"><span class="text"><?php echo $side[$i]['index_view'] ?></span></a></li>
                                <li><a href="<?php echo base_url(); ?>admin/<?php echo $side[$i]['index_controller'] ?>/add"><span class="text">
                                <?php echo $side[$i]['form_view'] ?></span></a></li>
                         ...
                         <li class="active"><a href="#" class="js-sub-menu-toggle"><i class="fa fa-dashboard fa-fw"></i><span class="text">العملاء</span>
                            <i class="toggle-icon fa fa-angle-down"></i></a>
                            <ul class="sub-menu">

                                <li><a href="<?php echo base_url(); ?>admin/clients"><span class="text">العملاء</span></a></li>
                            
                                 </ul>
                        </li>
                        <li class="active"><a href="#" class="js-sub-menu-toggle"><i class="fa fa-dashboard fa-fw"></i><span class="text">السائقين</span>
                            <i class="toggle-icon fa fa-angle-down"></i></a>
                            <ul class="sub-menu">

                                <li><a href="<?php echo base_url(); ?>admin/clients/drivers"><span class="text">السائقين</span></a></li>
                                <li><a href="<?php echo base_url(); ?>admin/clients/add"><span class="text">اضافة سائق</span></a></li>
                                 </ul>
                        </li>

                         <li class="active"><a href="#" class="js-sub-menu-toggle"><i class="fa fa-dashboard fa-fw"></i><span class="text">الاحصائيات</span>
                            <i class="toggle-icon fa fa-angle-down"></i></a>
                            <ul class="sub-menu">

                                <li><a href="<?php echo base_url(); ?>admin/statitcs"><span class="text">لكل التطبيق</span></a></li>
                            
                                 </ul>
                        </li>

                    <li class="active"><a href="#" class="js-sub-menu-toggle"><i class="fa fa-dashboard fa-fw"></i><span class="text">ارسال اشعار</span>
                            <i class="toggle-icon fa fa-angle-down"></i></a>
                            <ul class="sub-menu">

                                <li><a href="<?php echo base_url(); ?>admin/notification"><span class="text">ارسال</span></a></li>
