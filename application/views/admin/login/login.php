			...
			<div class="login-box center-block">
				<form class="form-horizontal" role="form" method="post">
					...
					<div class="form-group">
						<label for="username" class="control-label sr-only">البريد الالكتروني</label>
						<div class="col-sm-12">
							<div class="input-group">
								<input type="text" placeholder="الالكتروني" name="email" id="username" class="form-control" style="float: right; direction: rtl;">
					...
					<button  class="btn btn-custom-primary btn-lg btn-block btn-auth" style="font-family: 'gess';" name="submit"><i class="fa fa-arrow-circle-o-right"></i> دخول</button>
				</form>
				<div class="links">
