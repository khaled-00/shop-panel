              ...
              <form id="tryitForm" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                        ...
                        <?php 
                                ...
                                ?>
                                    ...
                                    <div class='form-group'>
                                        <label class='col-md-3 control-label'>الوصف بالانجليزية</label>
                                        <div class='col-md-8'>
                                ...
                                ?>
                                        ...
                                        <div class='form-group'>
                                            <label for='validate-select' class='col-md-3 control-label'>اختار القائمة</label>
                                ...
                                ?>
                                        ...
                                        <div class='form-group'>
                                            <label for='validate-select' class='col-md-3 control-label'>اختار المطعم</label>
                                ...
                                ?>
                                        ...
                                        <div class='form-group'>
                                            <label for='validate-select' class='col-md-3 control-label'>اختار نوع الطعام</label>
                                        ...
                                        <div class='col-md-9'>
                                            <div class='fileinput fileinput-new input-group' data-provides='fileinput'>
                                                ...
                                                <span class='input-group-addon btn btn-default btn-file'>
                                                    <span class='fileinput-new'>اختار</span>
