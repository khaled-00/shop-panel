        ...
        <div class="widget widget-table" style="overflow:auto;">
         ...
         <div class="widget-content">
             <table id="featured-datatable" class="table table-sorting table-striped table-hover datatable">
                                ...
                                <thead>
                                    <tr>
                                        <th>driver name</th><th>mobile</th><th>order count</th><th>status</th>
                                        <th>delete</th>
                               ...
                               <tbody>
                                        ...
                                        for ($i=0; $i < count($data); $i++) { 
                                            ...
                                            {
                                                echo'<td> <a href="'.base_url().'admin/clients/update_driver?id='.$data[$i]['id'].'&status=0&lang=en"><img src="'.base_url().'rec/img/remove.png" height="35" > </td>';
                                            }
                                            else 
                                            {
                                                echo'<td> <a href="'.base_url().'admin/clients/update_driver?id='.$data[$i]['id'].'&status=1&lang=en"><img src="'.base_url().'rec/img/paid.png" height="35" > </td>';
                                            }
