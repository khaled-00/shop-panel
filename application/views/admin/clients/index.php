             ...
             <table id="featured-datatable" class="table table-sorting table-striped table-hover datatable">
                               ...
                               <tbody>
                                        ...
                                        for ($i=0; $i < count($data); $i++) { 
                                            ...
                                            {
                                                echo'<td> <a href="'.base_url().'admin/clients/update?id='.$data[$i]['id'].'&status=0"><img src="'.base_url().'rec/img/remove.png" height="35" > </td>';
                                            }
                                            else 
                                            {
                                                echo'<td> <a href="'.base_url().'admin/clients/update?id='.$data[$i]['id'].'&status=1"><img src="'.base_url().'rec/img/paid.png" height="35" > </td>';
                                            }
